...
function BookItem({ el, onClick }: BookItemProps) {
    return (
        <div onClick={onClick} key={el.isbn} className="flex-shrink-0 inline-flex flex-col items-center text-center w-[150px] cursor-pointer m-1">
            <div
            ...
            >
                <img className="w-[calc(100%_-_4px)] h-[calc(100%_-_4px)] object-cover transition-transform duration-300 ease-in-out hover:scale-110" src={el.image} alt={`${el.title} 표지`} />
            </div>
