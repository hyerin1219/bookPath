...
export default function SearchBox({ value, onChange, onClick, placeholder }: ISearchBoxProps) {
    return (
        <div className="flex items-center gap-3 bg-white border border-gray-300 rounded-xl px-3 py-2 focus-within:shadow-md transition-shadow">
